...
$(DIR)main.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)server$(SEP)server_main.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)utils$(SEP)utils.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(SOURCES_DIR)$(SEP)utils$(SEP)utils.h
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)keys.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(SOURCES_DIR)$(SEP)keys.h
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)utils$(SEP)utf8.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(SOURCES_DIR)$(SEP)utils$(SEP)utf8.h
	$(CC) $(CMP_FLG) -c $< -o $@
...
$(DIR)gui_utils$(SEP)texts.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(SOURCES_DIR)$(SEP)gui_utils$(SEP)texts.h
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)network$(SEP)network.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(SOURCES_DIR)$(SEP)network$(SEP)network.h
	$(CC) $(CMP_FLG) -c $< -o $@
...
$(DIR)game$(SEP)direct_ex.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)main_scr.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)network$(SEP)encoding.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)server$(SEP)game_setup.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)server$(SEP)netgame.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
$(DIR)game$(SEP)net_ex.o: $$(patsubst $(DIR)%.o, $(SOURCES_DIR)$(SEP)%.cpp, $$@) $(HEADS)
	$(CC) $(CMP_FLG) -c $< -o $@
